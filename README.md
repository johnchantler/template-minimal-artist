# VenueCMS template-minimal-artist
...
Open [http://localhost:3000](http://localhost:3000) with your browser to see the result. You need to put the instance site ID before localhost. e.g. http://edition.localhost:3000
